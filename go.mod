module github.com/ST-Apps/codeclimate-tflint

go 1.19

require github.com/terraform-linters/tflint v0.39.3

require github.com/oriser/regroup v0.0.0-20210730155327-fca8d7531263
